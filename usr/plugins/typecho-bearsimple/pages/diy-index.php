...
<?php billboard($this->options->AdControl3Src,'other'); ?>
  ...
  <div class="swiper-container" id="swiper">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide"><img class="swiper-slide" src="<?php $this->options->themeUrl() ?>/modules/BearThumb/thumb.php?img=<?php echo $sliderpic;?>"></div>
        <?php } ?>
    </div>
...
<div class="bs-row">
   <?php while($this->next()): ?>
			<div class="bs-col" hrefs="<?php $this->permalink() ?>">
				<div class="bs-card" <?php if($this->options->articleradius): ?>style="border-radius:<?php $this->options->articleradius(); ?>px"<?php endif; ?>>
				    <?php if(thumb($this) !== "null"): ?>
					<img <?php if($this->options->articleradius): ?>style="border-radius:<?php $this->options->articleradius(); ?>px <?php $this->options->articleradius(); ?>px 0 0"<?php endif; ?> src="<?php $this->options->themeUrl() ?>/modules/BearThumb/thumb.php?img=<?php echo thumb($this); ?>" alt="">
					<?php endif; ?>
					<div class="bs-card-body" <?php if($this->options->articleradius): ?>style="border-radius:<?php $this->options->articleradius(); ?>px"<?php endif; ?>>
						<h5 class="bs-card-title">
							<?php $this->sticky(); ?><a><?php $this->title(articletitlenum(), '...') ?></a>
						</h5>
						<?php if($this->options->Article_time2 == "1"): ?>
						<p class="bs-date-author">
					<?php $this->date(); ?>
						</p>
						<?php endif; ?>
						<?php if($this->fields->excerpt == null): ?>
 	...
 	<div class="wrappers">
		  <div class="cols">
					<div class="col">
  <div class="blog-card" <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px"<?php endif; ?>>
    <div class="meta">
...
<div class="ui <?php if($this->options->textType == "1"): ?>raised<?php endif; ?><?php if($this->options->textType == "2"): ?>stacked<?php endif; ?><?php if($this->options->textType == "3"): ?>tall stacked<?php endif; ?><?php if($this->options->textType == "4"): ?>piled<?php endif; ?> segment" <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px"<?php endif; ?>>
	...
	<?php if($this->options->Article_time2 == "1"): ?>
		...
		<?php endif; ?>
			...
			<?php endif; ?>
			<?php endif; ?>
			</div><br><p class="readmore" style="float:right;"><a href="<?php $this->permalink() ?>">阅读全文</a></p></div>
</div>
