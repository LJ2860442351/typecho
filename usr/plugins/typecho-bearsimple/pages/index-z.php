   ...
   <?php while($this->next()): ?>
			...
			<div class="bs-col" hrefs="<?php $this->permalink() ?>">
				<div class="bs-card" style="border-radius:10px">
					...
					<img style="border-radius:10px 10px 0 0" src="<?php $this->options->themeUrl() ?>/modules/BearThumb/thumb.php?img=<?php echo thumb($this); ?>" alt="">
					<?php endif; ?>
					<div class="bs-card-body" style="border-radius:10px">
