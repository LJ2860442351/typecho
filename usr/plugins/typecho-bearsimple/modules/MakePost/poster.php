<nocompress>
<link rel="stylesheet" href="<?php $this->options->themeUrl('/modules/MakePost/poster/css/poster.css'); ?>" type="text/css" media="all">

<script src="<?php $this->options->themeUrl('/modules/MakePost/poster/js/html2canvas.min.js'); ?>"></script>
<script src="<?php $this->options->themeUrl('/modules/MakePost/poster/js/common.js'); ?>"></script>
