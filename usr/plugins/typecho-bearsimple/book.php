...
<div class="ui bottom attached tab active" data-tab="first">
    ...
    <div class="ui fluid card">
      ...
      <div class="ui dimmer">
        <div class="content">
          <div class="center">
            <a class="ui inverted button" href="<?php echo $Getdata['url']; ?>"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?>>我也要看</a>
          </div>
        </div>
      </div>
      <img id="imga" class="lazyload" data-src="<?php echo $Getdata['cover']; ?>" referrerPolicy="no-referrer">
    </div>
      <div class="content" style="text-align:center;">
        <a class="header" href="<?php echo $Getdata['url']; ?>"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?>>《<?php echo $Getdata['bookname']; ?>》</a>
        <div class="meta">
